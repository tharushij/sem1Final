...
public class lunchRecipe implements Comparable<lunchRecipe>
{
    //instance variables
    ...
    //full constructor
    public lunchRecipe(String newRecipeName, String newMajorIng, int newPrepTime, int newCookTime)
    {
    ...
    @Override
    public int compareTo(lunchRecipe someRecipe) {
